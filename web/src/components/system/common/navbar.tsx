...
// order. The emoji is drawer-only — the top bar renders labels alone.
const browseLinks = [
  { label: 'Home', to: '/', emoji: '🏠' },
...
interface TopNavbarProps {
  onSearchOpen: () => void
  onLeftNavbarOpen: () => void
}

// The fixed header. Below md the centered/personal navs collapse and the
