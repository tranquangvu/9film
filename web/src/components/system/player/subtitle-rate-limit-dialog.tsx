...
// Shown on the watch page when the shared subtitle-provider account gets
// rate-limited and the user hasn't added their own key. Nudges them to enter
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent>
        ...
        <DialogDescription>
          The shared subtitle account just hit its rate limit, so this subtitle couldn't be downloaded.
        </DialogDescription>
        ...
        <div className="mt-4 flex items-start gap-3 rounded-xl border border-white/10 bg-white/[0.03] p-3">
          ...
          <p className="text-sm text-zinc-300">
            Add your own subtitle provider <span className="font-semibold text-white">API key</span> in profile
            settings to download subtitles without limits.
          </p>
        </div>
